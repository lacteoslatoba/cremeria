...
export default async function Tienda({ searchParams }: { searchParams: Promise<{ category?: string, query?: string }> }) {
  // AuthGuard (cliente) tambien redirige "/tienda" sin sesion, pero ese chequeo
  ...
  // patron que /admin).
  //
  // La tienda vivia en "/" hasta el 25/09 -- se movio aqui para que
  // cremeriadelrancho.com pueda tener una landing publica (ver
  // src/app/page.tsx) con un boton de "Entrar a la tienda" hacia esta ruta.
  ...
  return (
    <main className="min-h-[100dvh] pb-safe">
      ...
      {/* Category Pills will navigate to /tienda?category=name */}
