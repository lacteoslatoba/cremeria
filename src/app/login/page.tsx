...
export default function LoginPage() {
    ...
    // El checkbox "Recordar sesión" ahora vive en DriverLoginForm (portal
    // Repartidor). Aquí se sigue mandando remember=true por default para
    // Cliente/Admin, que es como se comportaba antes.
    ...
    // match contra username/email/phone).
    ...
    // Portal Repartidor: el formulario vive en DriverLoginForm porque /driver
    // también lo pinta, directo al abrir la zona de reparto (antes había que
    // picar un botón "Iniciar sesión" ahí). Una sola copia del login.
                            ...
                            <form onSubmit={handleRegister} className="flex flex-col gap-4 animate-in fade-in zoom-in-95 duration-300">
                                ...
                                <div className="space-y-1 text-left">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-[#2d2a28] placeholder:text-gray-400 font-medium"
                                    />
                                    <p className="text-[10px] text-gray-400 pl-1">Con tu teléfono inicias sesión después</p>
                                </div>
