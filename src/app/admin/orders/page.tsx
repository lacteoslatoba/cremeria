...
export default async function AdminOrdersPage() {
    ...
    return (
        <div className="flex-1 flex flex-col p-8 overflow-y-auto">
            {/* Header */}
            <div className="mb-10">
                <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Pedidos Activos</h2>
                <p className="text-gray-500 mt-1 font-medium">Revisa y actualiza el estado de los pedidos de tus clientes.</p>
            </div>
                        ...
                        {orders.map((order: any) => (
                            <tr key={order.id} className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-4">
                                    ...
                                    <div className="text-sm text-gray-500 mt-1">{order.createdAt.toLocaleTimeString()} - {order.createdAt.toLocaleDateString()}</div>
                                </td>
