...
export default function EditProductPage() {
    ...
    if (isLoading) {
        return <div className="flex-1 flex justify-center items-center p-8"><Loader2 className="animate-spin text-primary" size={32} /></div>;
    }
    ...
    return (
        <div className="flex-1 flex flex-col p-8 overflow-y-auto bg-[#f8f9fa]">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Editar Producto</h2>
                    <p className="text-sm text-gray-500 mt-1 font-medium">Actualiza los detalles de tu inventario.</p>
                </div>
            </div>
